...
Делал интернет-магазины под ключ. Предпочитаемые технологии Backend - Laravel или nodejs, Frontend - Angular.
Но больше всего люблю именно сами верстку. Могу настраивать как gulp так и webpack. Хорошо владею препроцессорами.
Сам же предпочитаю связку gulp + pug + scss.
На данный момент разрабатываю сервис, который помогает мне верстать быстрее и не отвлекаться на рутину. 
